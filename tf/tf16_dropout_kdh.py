...
layer3 = tf.sigmoid(tf.matmul(layer3, w4)+b4)
layer3 = tf.nn.relu(tf.matmul(layer3, w4)+b4)
layer3 = tf.nn.elu(tf.matmul(layer3, w4)+b4)

h = tf.nn.softmax(tf.matmul(layer3, w4) + b4)
