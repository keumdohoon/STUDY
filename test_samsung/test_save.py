...
# datasets2 = pd.DataFrame(datasets2, index = [])

# datasets2.drop(['2020-06-02', '2020-06-01'])
datasets2 = datasets2.drop(datasets2.index[0])


print(datasets1)
print(datasets2)
print(datasets1.shape)  #(508, 5)
print(datasets2.shape)  #(508, 1)


#거래량str->int 변경
#hite
for i in range(len(datasets1.index)): 
    datasets1.iloc[i,1] = int(datasets1.iloc[i,1].replace(',',''))
