...
data = pd.read_csv('./data/csv/loan_traintest_data.csv')
prediction = pd.read_csv('./data/csv/loan_prediction_data.csv')
...
X_train, X_test, y_train, y_test = train_test_split(loans,prediction,
                                                    test_size=0.20,
                                                    random_state=101)
