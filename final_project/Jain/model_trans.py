...
# load data
x = np.load('D:\Study\Bitcamp\\final_project\model\\face_image_total.npy')
y = np.load('D:\Study\Bitcamp\\final_project\model\\face_label_total.npy')

print(x.shape) #(5530, 128, 128, 3)
print(y.shape) #(5530,)
...
# model
takemodel = Xception(weights='imagenet',include_top=False, input_shape = (128, 128, 3))
...
cp = ModelCheckpoint('D:\Study\Bitcamp\\final_project\model_save\\best_effB3_32.hdf5', monitor = 'val_loss',
