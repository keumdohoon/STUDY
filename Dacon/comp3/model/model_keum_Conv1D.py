# 퓨리에 와 콘보 1디 적용하고 앙상블까지 적용할수 있으면 적용하기.
...
from keras.layers import Dense, Activation, Conv2D, Flatten,MaxPooling2D,BatchNormalization,Lambda, MaxPooling1D,AveragePooling2D, Conv1D
...
print(X_data_test.shape)#(262500, 5)
...
# X_train = X_data
# Y_train = Y_data
print(X_train.shape)#(2772, 375, 5)
...
def set_model(train_target):  # 0:x,y, 1:m, 2:v
    ...
    model.add(Conv1D(nf,fs, padding=padding, activation=activation,input_shape=(375,5)))
...
submit.to_csv('./dacon/comp3/sub/comp3_Conv1D_submit1.csv', index = False)
