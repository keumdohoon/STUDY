...
# X_train = X_data
# Y_train = Y_data
print(X_train.shape)#(2772, 375, 5, 1)

weight1 = np.array([1,1,0,0])
weight2 = np.array([0,0,1,1])

def my_loss(y_true, y_pred):
    divResult = Lambda(lambda x: x[0]/x[1])([(y_pred-y_true),(y_true+0.000002)])
...
submit.to_csv('./dacon/comp3/sub/comp3_submit_5.csv', index = False)
